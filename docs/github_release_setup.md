...
- versión base: 0.5.1
- tag esperado en GitHub: v0.5.1
- binario OTA esperado: .pio/build/esp32c3/snapfan-esp32c3-v0.5.1.bin
...
```powershell
powershell -ExecutionPolicy Bypass -File .\tools\publish_all.ps1 -Version 0.5.1
```
